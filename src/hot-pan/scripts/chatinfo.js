...
export class ChatInfo {
        ...
        <div style="text-align: justify; color: #000000; padding: 10px; background-color: #CCD0CC; border: 2px solid #FFFFFF; border-radius: 15px;">
            <p style="text-align: center;">
                <a href="${Config.data.modlink}">
                    <img src="modules/${Config.data.modID}/artwork/${Config.data.modID}-logo.gif" alt="${Config.data.modTitle} - Logo" style="border:0"/>
                </a>
                <br/>
                Version: chatInfoContent.version [<a href="modules/${Config.data.modID}/CHANGELOG.MD/">Changelog</a>]
            </p>
            <hr><div>
                <h2 style="text-align: left">chatInfoContent.title</h2>
            </div>
            <hr>
            <div>
                <p style="text-align: left; font-style: italic; font-weight: lighter">chatInfoContent.text1</p>
                <p/>
    ...
    static contentCardHTML_AlwaysCentredWarning = `
    <div class="div-styled" style= "padding: 5px;">
        <div style="text-align: justify; color: #000000; padding: 10px; background-color: #CCD0CC; border: 2px solid #FFFFFF; border-radius: 15px;">
            <p style="text-align: center">
                <a href="${Config.data.modlink}">
                ...
                <a href="https://github.com/SDoehren/always-centred">
                    <img src="modules/${Config.data.modID}/artwork/always-centred-logo.png" alt="Always Centred - Logo" style="border:0"/>
                </a>
                <br/>
                Version: chatInfoContent.version [<a href="modules/${Config.data.modID}/CHANGELOG.MD/">Changelog</a>]
            </p>
            <hr><div>
                <h2 style="text-align: left; color: red">chatInfoContent.title</h2>
            </div>
            <hr>
            <div>
                <p style="text-align: left; font-style: normal; font-weight: lighter; color: red">chatInfoContent.text</p>
            </div>
            <hr>
            <div class="div-styled" style="font-style: italic; font-weight: lighter">
                <p style="text-align: left;">chatInfoContent.footer</p>
                ...
                if (Config.setting('hideChatWarnings') === false) {
                    ...
                    await ChatMessage.create({
                        ...
                        content: ChatInfo.contentCardHTML_AlwaysCentredWarning
                            .replace('chatInfoContent.title', Config.localize('autoFocus.msg.alwaysCentredWarning.title'))
                            .replace('chatInfoContent.text', Config.localize('autoFocus.msg.alwaysCentredWarning.text'))
                            .replace('chatInfoContent.footer', Config.localize('chatInfoContent.footer'))
                            .replace('chatInfoContent.version', Config.setting('modVersion'))
                        ,
                    }, {});
